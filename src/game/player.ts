...
export default class Player {
  ...
  createAnimation(scene: Phaser.Scene): void {
    ...
    scene.anims.create({
      key: 'runPlayer',
      frames: scene.anims.generateFrameNames('fox', { prefix: 'Run_', end: 8, zeroPad: 2 }),
      repeat: -1,
    });
    this._sprite
    ...
    scene.anims.create({
      key: 'jumpPlayer',
      frames: scene.anims.generateFrameNames('fox', { prefix: 'Jump_', end: 9, zeroPad: 2 }),
      repeat: 0,
    });
    this._sprite
      .setScale(SCALE_SIZE_PLAYER)
    ...
    scene.anims.create({
      key: 'stayPlayer',
      frames: scene.anims.generateFrameNames('fox', { prefix: 'Idle_', end: 10, zeroPad: 2 }),
      repeat: -1,
    });
    this._sprite
      .setScale(SCALE_SIZE_PLAYER)
